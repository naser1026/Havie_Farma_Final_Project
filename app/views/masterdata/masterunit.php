            ...
            <div class="card body">
                ...
                <div style= "margin-left : 11%; padding-top : 2rem";>
                    <button type="button" class="btn btn-primary addProduct" data-bs-toggle="modal"
                        ...
                        <b><i class="ri-add-fill "></i></b>Tambah Unit</button>
                </div>
                <div class="row">
                        ...
                        <tbody>
                            ...
                            foreach ($unit as $row):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning unitModalUpdate"
                                            href="<?= BASEURL ?>masterdata/masterunitUpdate/<?= $row['id_unit_tmun'] ?>"
                                            data-bs-toggle="modal" data-bs-target="#staticBackdrop" role="button"
                                            data-id="<?= $row['id_unit_tmun']; ?>" data-url="<?= BASEURL; ?>"><i class="ri-edit-2-line"></i></a>
                                        <a class="btn btn-danger"
                                            href="<?= BASEURL ?>masterdata/masterunitDelete/<?= $row['id_unit_tmun'] ?>"
                                            role="button"
                                            onclick="return confirm('Hapus <?= $row['name_tmun'] ?>')"><i class="bx bx-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
